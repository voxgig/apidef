...
# sits under a NOT_DOCS prefix: the design proposals and the code reviews
# are working documents, not documentation.
DOC_GLOBS = ("docs/**/*.md",)
NOT_DOCS = ("docs/design/", "docs/review/")

# Pages outside the tree. None here: neither ts/ nor go/ carries a README
# of its own, and ts/cmd/README.md is a maintainer note on the packaging
# scripts rather than a page a reader lands on.
EXTRA_PAGES = ()
...
WORKING_DOCS = (
    ...
    (r"\bADR\.md\b", "ADR.md"),
    (r"\bTODO\.md\b", "TODO.md"),
    (r"(?:\bdocs|\.{1,2})/design/", "a design document (docs/design/)"),
    (r"(?:\bdocs|\.{1,2})/review/", "a review (docs/review/)"),
...
REQUIRED_PAGES = (
    ...
    "docs/explanation/canonical-and-parity.md",
    "docs/explanation/classification-heuristics.md",
    "docs/explanation/the-internal-model.md",
    "docs/how-to/control-the-pipeline.md",
    "docs/how-to/customize-entity-naming.md",
    "docs/how-to/debug-a-build.md",
    "docs/how-to/release-and-tag.md",
    "docs/how-to/use-as-a-library.md",
    "docs/how-to/use-the-cli.md",
    "docs/how-to/work-on-the-codebase.md",
