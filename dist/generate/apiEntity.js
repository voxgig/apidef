...
exports.generateApiEntity = generateApiEntity;
const node_path_1 = __importDefault(require("node:path"));
const jostraca_1 = require("jostraca");
const utility_1 = require("../utility");
function generateApiEntity(apimodel, spec, opts, res) {
    const { fs, log } = res;
    ...
    const indexFile = node_path_1.default.join(apiFolder, (null == opts.outprefix ? '' : opts.outprefix) + 'entity-index.jsonic');
    (0, utility_1.writeChanged)('api-entity-index', indexFile, barrel.join('\n'), fs, log);
}
